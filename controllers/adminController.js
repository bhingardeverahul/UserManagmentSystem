...
const sendResetPasswordMail = async(name, email, token)=>{
    ...
    try {
        ...
        const mailOptions = {
            ...
            html:'<p>Hii '+name+', please click here to <a href="https://usermanamentsystem-1.onrender.com/admin/forget-password?token='+token+'"> Reset </a> your password.</p>'
        }
...
const addUserMail = async(name, email, password, user_id)=>{
    ...
    try {
        ...
        const mailOptions = {
            ...
            html:'<p>Hii '+name+', please click here to <a href="https://usermanamentsystem-1.onrender.com/verify?id='+user_id+'"> Verify </a> your mail.</p> <br><br> <b>Email:-</b>'+email+'<br><b>Password:-</b>'+password+''
        }
        transporter.sendMail(mailOptions, function(error,info){
            if(error){
                console.log(error);
